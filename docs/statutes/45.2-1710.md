...
**Relevance to this project:** subsection B enumerates twelve required Plan elements. Submissions
to the Virginia Energy Plan are most usable when structured against these. B.2 (distributed energy
resources), B.3 (impediments to distributed resources and recommendations to remove them),
B.4 (fuel diversity and flexibility), and B.12 (legislative and regulatory recommendations) map
most directly onto this project's analysis.
