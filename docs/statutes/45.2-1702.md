# § 45.2-1702. Definitions. (Energy performance-based contracting)

*Verbatim text. Public domain. Retrieved 2026-09-10. Source: law.lis.virginia.gov*

**Relevance to this project:** this article governs energy performance contracting (ESPC) by public
bodies — an existing statutory mechanism requiring no new legislation. An energy performance-based
contract requires that annual savings "meet or exceed the total annual contract payments," backed
by a performance guarantee bond, so public bodies can implement measures with no net budget impact
and the contractor carrying performance risk. Several enumerated measures map onto demand-side
categories in this project's scope: (4) HVAC replacement (heat pumps), (3) automatic energy control
systems (building energy management), (10) installation of solar, and (11) water consumption devices
(heat pump water heaters). Connects to § 56-585.5(C)(2), which directs a portion of the ≤1 MW
distributed requirement toward projects on or adjacent to public elementary or secondary schools.
